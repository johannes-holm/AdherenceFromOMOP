...
add_info_to_adherence <- function(adherence_df, schema){
  id_age_gender<-querySql(conn, paste0("SELECT person_id, gender_concept_id, year_of_birth FROM ",schema,".person"))
